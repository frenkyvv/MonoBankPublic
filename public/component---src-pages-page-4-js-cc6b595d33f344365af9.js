"use strict";(self.webpackChunkgatsby_starter_default=self.webpackChunkgatsby_starter_default||[]).push([[605],{9365:function(e,a,t){var n=t(6540);const r=t(7581).Ay.button`
...
`,T=c.Ay.div`
  ...
  z-index: 1000;
`;var z=t(9365);var B=function(){const{0:e,1:a}=(0,n.useState)(!1),{0:t,1:c}=(0,n.useState)([]),{0:s,1:u}=(0,n.useState)(!0),m=(0,d.rJ)(i.default,"jugadores"),g=(0,d.P)(m);(0,n.useEffect)((()=>{(0,d.aQ)(g,(e=>{const a=[];e.forEach((e=>{a.push(e.data())})),c(a),u(!1)}))}),[]);const p=t.length>0?t[3]:null;return n.createElement(o.A,null,n.createElement(l.A,{title:"Frenky"}),n.createElement(H,null,p&&n.createElement(n.Fragment,null,n.createElement(P,null,p.nombre),n.createElement(F,null,p.saldo),n.createElement(z.A,{onClick:()=>{a(!e)},mostrarPropiedades:e}),e?n.createElement(n.Fragment,null,n.createElement(k,null),n.createElement(x,null)):n.createElement(f,null),n.createElement(r.Link,{to:"/"},"Go back to the homepage"))))};const H=c.Ay.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
...
`,F=c.Ay.div`
  font-size: 24px;
`}}]);
//# sourceMappingURL=component---src-pages-page-4-js-cc6b595d33f344365af9.js.map